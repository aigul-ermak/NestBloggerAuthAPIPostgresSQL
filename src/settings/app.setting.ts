...
class APISettings {
  ...
  constructor(private readonly envVariables: EnvironmentVariable) {
    ...
    this.MONGO_DBName = envVariables.MONGO_DBName ?? 'db';
    ...
    this.MONGO_DBName = envVariables.MONGO_DBName ?? 'home-works-db';

    this.TEST_DBName = envVariables.TEST_DBName ?? 'test-db';
  }
